<?php
	...
	/*
 	 * PHP script for validating input received from the About Us web page
 	 * inserting it into the table, and sending the user a confirmation email.
	...
	// regex taken from: http://www.w3schools.com/php/php_form_url_email.asp
	// must match word character + @ + word character + '.' + word character
